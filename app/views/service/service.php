   ...
   <div class="container mt-4 mt-lg-0">
     <div class="row d-lg-flex justify-content-center">
       ...
       <div class="col-lg-4 col-12 text-end">
         <img src="assets/img/creating-a-new-business.svg" alt="" class="img-fluid mt-4 mt-lg-0" />
       </div>
     </div>
   </div>
 </section>
 ...
 <section id="creating-new-feature">
   <div id="creating-new-feature">
     <div class="container">
       <div class="row d-lg-flex justify-content-center">
         <div class="col-lg-4">
           <img src="assets/img/create-new-features.png" alt="" class="img-fluid mt-5 mt-lg-0" />
         </div>
 ...
 <section id="redesign-your-web-or-app">
   <div class="container">
     <div class="row d-lg-flex justify-content-center">
       ...
       <div class="col-lg-4">
         <img src="assets/img/redesign-img.svg" alt="" class="img-fluid mt-4 mt-lg-0" />
       </div>
     </div>
   </div>
 </section>
 ...
 <section id="creating-a-business-brand">
   <div class="container">
     <div class="row d-lg-flex justify-content-center">
       <div class="col-lg-4">
         <img src="assets/img/creating-business-brand.svg" alt="" class="img-fluid mt-4 mt-lg-0" />
       </div>
       <div class="col-lg-4 col-creating-a-new-business">
         <div class="title-creating-a-new-business text-end mt-4 mt-lg-0">
